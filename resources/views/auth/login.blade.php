    ...
    <form action="{{ route('login') }}" method="POST" class="space-y-4">
        ...
        <div class="space-y-1.5">
            ...
            <div class="relative">
                ...
                <button type="button" @click="showPassword = !showPassword" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 transition-colors z-10">
