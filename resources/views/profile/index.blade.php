                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6" x-show="changePwd" x-cloak
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" @click="showP1 = !showP1" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 transition-colors">
                                <i data-lucide="eye" class="w-4 h-4" x-show="!showP1"></i>
                                <i data-lucide="eye-off" class="w-4 h-4" x-show="showP1" x-cloak></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input :type="showP2 ? 'text' : 'password'" name="new_password" id="new_password" placeholder="Min 6 karakter" ::required="changePwd"
                                   class="w-full pl-10 pr-10 py-2.5 bg-slate-50 focus:bg-white text-slate-800 text-sm rounded-xl border border-slate-200 focus:border-blue-500 focus:outline-none transition-all">
                            <button type="button" @click="showP2 = !showP2" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 transition-colors">
                                <i data-lucide="eye" class="w-4 h-4" x-show="!showP2"></i>
                                <i data-lucide="eye-off" class="w-4 h-4" x-show="showP2" x-cloak></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            <input :type="showP3 ? 'text' : 'password'" name="new_password_confirmation" id="new_password_confirmation" placeholder="Ulangi password" ::required="changePwd"
                                   class="w-full pl-10 pr-10 py-2.5 bg-slate-50 focus:bg-white text-slate-800 text-sm rounded-xl border border-slate-200 focus:border-blue-500 focus:outline-none transition-all">
                            <button type="button" @click="showP3 = !showP3" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 hover:text-slate-600 transition-colors">
                                <i data-lucide="eye" class="w-4 h-4" x-show="!showP3"></i>
                                <i data-lucide="eye-off" class="w-4 h-4" x-show="showP3" x-cloak></i>
                            </button>
                        </div>
                    </div>
                </div>
